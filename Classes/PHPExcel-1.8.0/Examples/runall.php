...
foreach ($aTests as $sTest) {
	@unlink( str_replace('Excel.php', '.xls', 	$sTest) );
	@unlink( str_replace('Excel.php', '.xlsx', 	$sTest) );
	@unlink( str_replace('Excel.php', '.csv',	$sTest) );
	@unlink( str_replace('Excel.php', '.htm',	$sTest) );
	@unlink( str_replace('Excel.php', '.pdf',	$sTest) );
}
