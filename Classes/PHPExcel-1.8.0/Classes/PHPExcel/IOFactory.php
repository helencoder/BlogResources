...
class PHPExcel_IOFactory
{
	...
	private static $_searchLocations = array(
		array( 'type' => 'IWriter', 'path' => 'PHPExcel/Writer/{0}Excel.php', 'class' => 'PHPExcel_Writer_{0}' ),
		array( 'type' => 'IReader', 'path' => 'PHPExcel/Reader/{0}Excel.php', 'class' => 'PHPExcel_Reader_{0}' )
	);
	 ...
	 * @param	string $location	Example: PHPExcel/Writer/{0}Excel.php
